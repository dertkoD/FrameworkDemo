...
{
    public partial class АвтосервисКонтрагентыТаблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "2070c3a6-fc8d-414b-9175-7f31a54ee982")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "АвтосервисКонтрагентыТаблица";
        ...
        [NsgReferentsFilterAttribute("Автосервис.Контрагенты")]
