...
namespace Авто.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "2070c3a6-fc8d-414b-9175-7f31a54ee982")]
    public partial class АвтосервисКонтрагентыТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected АвтосервисКонтрагентыТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected АвтосервисКонтрагентыТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static АвтосервисКонтрагентыТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2070c3a6-fc8d-414b-9175-7f31a54ee982"));
            if (obj == null)
                obj = new АвтосервисКонтрагентыТаблица();
            return obj as АвтосервисКонтрагентыТаблица;
        }
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.АвтосервисКонтрагентыТаблица";
        }
        ...
        /// </summary>
        public new АвтосервисКонтрагентыТаблица.Строка NewRow()
        {
            return newRow(null) as АвтосервисКонтрагентыТаблица.Строка;
        }
        ...
        {
            if (row == null)
                row = new АвтосервисКонтрагентыТаблица.Строка(this);
            return base.newRow(row) as АвтосервисКонтрагентыТаблица.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public АвтосервисКонтрагентыТаблица.Строка NewRow(АвтосервисКонтрагентыТаблица.Строка inRow)
        {
            АвтосервисКонтрагентыТаблица.Строка row = inRow.Clone as АвтосервисКонтрагентыТаблица.Строка;
            return base.newRow(row) as АвтосервисКонтрагентыТаблица.Строка;
        }
        ...
        /// </summary>
        public new АвтосервисКонтрагентыТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as АвтосервисКонтрагентыТаблица.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new АвтосервисКонтрагентыТаблица.Строка GetEtalonRow()
        {
            АвтосервисКонтрагентыТаблица.Строка row = new АвтосервисКонтрагентыТаблица.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private АвтосервисКонтрагентыТаблица.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            АвтосервисКонтрагентыТаблица.Строка[] res = new АвтосервисКонтрагентыТаблица.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new АвтосервисКонтрагентыТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as АвтосервисКонтрагентыТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисКонтрагентыТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисКонтрагентыТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as АвтосервисКонтрагентыТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new АвтосервисКонтрагентыТаблица.Строка FindRow(string inName, object inValue)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисКонтрагентыТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисКонтрагентыТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// </summary>
        public  NsgVirtualCursor<АвтосервисКонтрагентыТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<АвтосервисКонтрагентыТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new АвтосервисКонтрагентыТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new АвтосервисКонтрагентыТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new АвтосервисКонтрагентыТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as АвтосервисКонтрагентыТаблица.Строка;
        }
        #endregion
        ...
        private АвтосервисКонтрагентыТаблица[] convertArray(NsgMultipleObject[] array)
        {
            АвтосервисКонтрагентыТаблица[] res = new АвтосервисКонтрагентыТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual АвтосервисКонтрагентыТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисКонтрагентыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисКонтрагентыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисКонтрагентыТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new АвтосервисКонтрагентыТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(АвтосервисКонтрагентыТаблица);
            }
			...
			public new АвтосервисКонтрагентыТаблица Value
            {
                get
                {
                    return (АвтосервисКонтрагентыТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
