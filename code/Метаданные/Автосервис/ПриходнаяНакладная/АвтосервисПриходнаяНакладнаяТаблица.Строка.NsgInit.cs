...
{
    [NsgTypeName("NsgDataTableRow", Guid = "40eae819-160e-4fed-a8c7-5009d3072f4f")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "АвтосервисПриходнаяНакладнаяТаблица";
        ...
        [NsgReferentsFilterAttribute("Автосервис.ПриходнаяНакладная")]
