...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataAssemblyObject", Guid = "917ee7c3-af95-457f-9674-62bc94237fc1")]
    public partial class DataAssemblyObject : NsgSoft.DataObjects.NsgDataAssemblyObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("917ee7c3-af95-457f-9674-62bc94237fc1"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("959dd96e-1a27-485b-90a6-394cdf95133c");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("923f8cbc-577d-4e80-9115-3bc059b19c7e");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("0de6e833-40cf-4e47-a717-f52cea6881b7");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("d64879fd-1b88-4a84-b3a8-828cb4c7ed1d");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("22c16b34-8a98-4310-845a-15ac4135d46f");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("818c0444-eb0c-41d4-bbdc-965dc8a966f0");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("dfa29f63-36e1-4fda-902b-87f1b58e8d06");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("e351416a-a447-4c7c-ad4a-31b1424ac759");
	...
	_AsmName.GroupName = "";
	_AsmName.Guid = NsgService.StringToGuid("268a8f34-1cda-479b-8c02-7ca7f6c57c77");
	...
	_AsmVersion.Guid = NsgService.StringToGuid("8924344e-e6d6-406b-996b-2f126d97f64c");
	...
	_AsmHash.GroupName = "";
	_AsmHash.Guid = NsgService.StringToGuid("335bca1b-f57c-4a47-8a66-e2d0101a1c95");
	...
	_AsmData.GroupName = "";
	_AsmData.Guid = NsgService.StringToGuid("2c188da0-d2ed-4b5e-94fe-d78a3103472e");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("c182523e-f268-4944-856d-44b6cc48f7f5");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("917ee7c3-af95-457f-9674-62bc94237fc1");
	DefaultSortingName = "";
