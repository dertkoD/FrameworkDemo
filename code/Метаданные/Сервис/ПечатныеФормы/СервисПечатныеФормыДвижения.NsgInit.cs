...
namespace Авто.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "d42e0aca-9c52-43dc-97a0-42ceddbbe77e")]
	...
	Идентификатор.Guid = NsgService.StringToGuid("6b68c5e3-0783-45c1-a44c-5b9fcc3a664e");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("fa42c1f3-a18b-4cfd-992a-4b3957d69d00");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("dc4e8db4-3592-4941-a6f0-5bba99ad042d");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("d42e0aca-9c52-43dc-97a0-42ceddbbe77e");
	DefaultSortingName = "";
