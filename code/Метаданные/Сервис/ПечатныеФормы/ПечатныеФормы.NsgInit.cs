...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataCharacteristics", Guid = "810c08c1-795e-4ab7-b82e-4ae4e8159826")]
    public partial class ПечатныеФормы : NsgSoft.DataObjects.NsgDataCharacteristics
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("810c08c1-795e-4ab7-b82e-4ae4e8159826"));
            if (obj == null)
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("4f13ba0a-330a-4647-926e-7fb37283ec40");
	...
	КонецПериода.Guid = NsgService.StringToGuid("5a36b879-56a9-4f43-8c79-1740f7ae2efd");
	...
	Идентификатор.Guid = NsgService.StringToGuid("e74bd6f0-b79d-42a0-9027-90596f567992");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a00ea301-ceaf-4aab-971b-d435f3ea55af");
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("6ad0a0ad-914a-446f-b685-cfee3f370616");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("fff3066f-2c17-4475-a242-ff30511b0bab");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("60f40d3c-f65b-429e-84b5-69baa05ce293");
	...
	Обработка.GroupName = "";
	Обработка.Guid = NsgService.StringToGuid("765b5cdb-a15b-457b-b246-55fa8c34e036");
	...
	Наименование.Guid = NsgService.StringToGuid("d1b67fcf-464c-47d5-9a68-b63b76f1e38c");
	...
	ПечатнаяФорма.Guid = NsgService.StringToGuid("7100f539-e7d9-47c4-bdb6-7e84218f700b");
	...
	Условие.GroupName = "";
	Условие.Guid = NsgService.StringToGuid("e3b1abbf-5c26-4c57-8eaa-709b05f4e776");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("2d8ddd67-905a-417b-be37-19dbfeb74885");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("3473f6b1-4958-4d7b-9880-eda5a82f5db6");
	...
	Name = "ПечатныеФормы";
	Visible = true;
	Guid = NsgService.StringToGuid("810c08c1-795e-4ab7-b82e-4ae4e8159826");
	DefaultSortingName = "";
