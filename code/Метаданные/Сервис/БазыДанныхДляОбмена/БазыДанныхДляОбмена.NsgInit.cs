...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "2c4d9ea8-61ce-4f8b-82de-5f7722cbd1fa")]
    public partial class БазыДанныхДляОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2c4d9ea8-61ce-4f8b-82de-5f7722cbd1fa"));
            if (obj == null)
