...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "cf2cad58-c990-4978-95ad-68235ae4c055")]
    public partial class СписокСообщений : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("cf2cad58-c990-4978-95ad-68235ae4c055"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("6fb0c3ef-f28d-496c-849a-9562881a1cf4");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("ecf59dd9-60b7-4432-9c7c-44d83bbf1d0c");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("61bfc827-d1a6-4e15-be1e-4d3175be6f3b");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("4a170872-3d71-4fa6-888f-b60ef98e9b54");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("3f1dbde8-7176-4db1-9109-17bbeaa126ba");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("b66693fd-48bd-491d-88be-86791cc9a16c");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("35fdc3f9-b98c-4500-b474-8f8aa10adb26");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("d3e1a7c2-e324-4e5d-a611-d75a643c76b5");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("76c210a3-c672-46e7-9edf-014667374be5");
	...
	ТипСообщения.Guid = NsgService.StringToGuid("eb0642d7-2f4a-4d5a-94dd-75411f6220a3");
	...
	ТекстСообщения.Guid = NsgService.StringToGuid("e0753492-8c5f-4628-bf8f-cb2dba583bd1");
	...
	ОбъектСообщения.Guid = NsgService.StringToGuid("28942b3e-ae17-4fdb-95a7-0554736efb8d");
	...
	АдресатСообщения.Guid = NsgService.StringToGuid("373a8d73-a378-409c-b648-264080868dd6");
	...
	АктуальностьСообщения.Guid = NsgService.StringToGuid("7ffaccb4-3694-4694-b7ae-7a9738d1c4db");
	...
	ВремяПоявленияСообщения.Guid = NsgService.StringToGuid("30fc685a-7b0a-47bd-af2b-67c9fcd5d721");
	...
	СтатусСообщения.Guid = NsgService.StringToGuid("91317bf8-c43a-44f4-b592-140377a6c981");
	...
	АвторСообщения.Guid = NsgService.StringToGuid("0b36ac5c-4919-4065-8ff2-83065f742b93");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("50ce6f43-4733-4120-8d3b-452165439889");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("9f6a2b4d-6632-4476-b5fc-f4b9432eae17");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("cf2cad58-c990-4978-95ad-68235ae4c055");
	DefaultSortingName = "";
