...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "0c15eab3-1807-4fd0-a3d0-e3b2bee01c88")]
    public partial class ТипыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("0c15eab3-1807-4fd0-a3d0-e3b2bee01c88"));
            if (obj == null)
                obj = new ТипыОбмена();
	...
	Идентификатор.Guid = NsgService.StringToGuid("13b29bdb-8d7d-4a00-aee7-fc2aad1e4933");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("197caaf2-db4a-44cf-90eb-4fe98f9ecc9a");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("63c02531-0887-4a74-aca4-c476b675be1d");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("db790e2a-6815-4bda-a461-0ddf241bed09");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("da2cb095-7cb4-45ad-9bd7-7f2e4a84b751");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("c660d93b-b628-4201-91fe-5906c9debe61");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("c17217d1-dff0-4307-9bbd-4d9a7c9b9863");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("adbabb4e-1fa0-4ffa-908c-17ac0487fd15");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("3e962a14-b625-460d-899c-9d193c53b9ae");
	...
	Наименование.Guid = NsgService.StringToGuid("27b6ae40-8c2e-4fcc-a86b-fb7f282e1f02");
	...
	Файл.Guid = NsgService.StringToGuid("900cb9e0-466f-4fec-a34f-55a304c7e646");
	...
	Email.Guid = NsgService.StringToGuid("50a48d91-a3ce-4e83-94a5-3bc7c28b4712");
	...
	SQL.Guid = NsgService.StringToGuid("7e9779fd-9f77-4031-bec3-faeaa2d109a8");
	...
	Name = "ТипыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("0c15eab3-1807-4fd0-a3d0-e3b2bee01c88");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        public static ТипыОбмена Файл
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("0c15eab3-1807-4fd0-a3d0-e3b2bee01c88"), NsgService.StringToGuid("900cb9e0-466f-4fec-a34f-55a304c7e646"));
            }
        }
        ...
        public static ТипыОбмена Email
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("0c15eab3-1807-4fd0-a3d0-e3b2bee01c88"), NsgService.StringToGuid("50a48d91-a3ce-4e83-94a5-3bc7c28b4712"));
            }
        }
        ...
        public static ТипыОбмена SQL
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("0c15eab3-1807-4fd0-a3d0-e3b2bee01c88"), NsgService.StringToGuid("7e9779fd-9f77-4031-bec3-faeaa2d109a8"));
            }
        }
