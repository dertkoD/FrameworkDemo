...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "0f69d552-7612-45d4-bcac-7b005c3c15d1")]
    public partial class ПравилаОбменаДанными : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("0f69d552-7612-45d4-bcac-7b005c3c15d1"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("64f181ff-ecdf-44f4-bb77-a311b3619002");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("d3897646-5ff7-4021-8669-0257e23995af");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("39747993-53a8-4ef7-9b89-6786ac03422e");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("5a371fac-cf92-44a3-bba9-4fd5fef63330");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("8d908005-6262-42fb-a5e2-35b8d2f70202");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("d9b5784a-3cd0-4342-a8cc-09c39edc29d3");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("a87bfd13-9840-4531-9675-0053a5c4b47f");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("010226d1-dad6-4aed-a6d4-5154a62abbb5");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("1db9a925-da7f-4700-9915-ebe2032fe50a");
	...
	ТипОбъектаОбмена.Guid = NsgService.StringToGuid("84219b2a-c021-4ec9-a04e-897f1776b473");
	...
	ВыгрузкаЗависимыхОбъектов.Guid = NsgService.StringToGuid("50f32d34-e74d-41cc-bcb8-4f48c9cb5c22");
	...
	БазаИсточник.Guid = NsgService.StringToGuid("d413e165-06f2-4751-9b38-adf0cc0ae32d");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("dafb220b-0c3b-407d-809f-61bec27f9340");
	...
	ПроводитьВсеДокументы.Guid = NsgService.StringToGuid("deb28ff9-1a48-42c9-a68f-147230437c1b");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("0f69d552-7612-45d4-bcac-7b005c3c15d1");
	DefaultSortingName = "";
