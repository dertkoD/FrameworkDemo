...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "a93bc854-0396-41ce-b0a3-ff548ff575a6")]
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a93bc854-0396-41ce-b0a3-ff548ff575a6"));
            if (obj == null)
