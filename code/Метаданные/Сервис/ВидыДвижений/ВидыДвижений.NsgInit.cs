...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "2df52aed-43af-454e-9d12-e5b9181d5de3")]
	...
	Расход.GroupName = "";
	Расход.Guid = NsgService.StringToGuid("061de208-747c-4a55-a04e-a021f3ba6634");
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2df52aed-43af-454e-9d12-e5b9181d5de3"));
            if (obj == null)
