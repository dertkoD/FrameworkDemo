...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "640dc728-c797-4289-a92e-da515a18bafe")]
    public partial class НастройкиКаналаОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("640dc728-c797-4289-a92e-da515a18bafe"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("ab2e101c-71f7-4dd6-a7cb-111b502d0b32");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("712ac72b-1019-4007-abb8-eda0943d4544");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("418e6e6c-6527-4c77-a074-0ebb14ba5896");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("a51ef715-b0a3-4229-b9a0-a77737c770f7");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ff1e44bd-2123-40af-8cbb-42e7c91768a4");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("443cd608-386c-4b99-bcbb-47c70d513afa");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("2ef1723f-e3fe-4ed2-afa1-9ecfc5790abc");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("7309c146-a1f3-4a2f-bb03-f841cbf39f2b");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("d830c9cd-ed48-444d-aae2-d77e752c8b75");
	...
	БазаИсточник.Guid = NsgService.StringToGuid("522e0dcf-3ab9-465e-8d7d-e759a503f574");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("638c2693-4799-4aad-88e8-deb42add55a9");
	...
	ТипОбмена.GroupName = "";
	ТипОбмена.Guid = NsgService.StringToGuid("76092986-b2c1-47c6-8c45-ed077ef9ecc7");
	...
	ПараметрыОбмена.Guid = NsgService.StringToGuid("9c4ffd7a-1cda-464f-9e7c-2b09ef3018cd");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("640dc728-c797-4289-a92e-da515a18bafe");
	DefaultSortingName = "";
