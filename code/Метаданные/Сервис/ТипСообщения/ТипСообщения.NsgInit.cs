...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "6fbbaff2-244b-4f4c-b1cf-aaedcff43dd9")]
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6fbbaff2-244b-4f4c-b1cf-aaedcff43dd9"));
            if (obj == null)
