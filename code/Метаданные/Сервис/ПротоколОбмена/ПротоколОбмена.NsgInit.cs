...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "106ae43c-7ece-473b-b6ee-d9d142751bc5")]
    public partial class ПротоколОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("106ae43c-7ece-473b-b6ee-d9d142751bc5"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("783bcddd-0ce9-4d22-acb6-4e0e5441621c");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a993365e-bc81-4d67-b95d-4a1d12ed8f26");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("776fba0a-5396-4a21-b538-7f32f5552d99");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("05aac52f-7fc7-4fab-8fb9-f1803a7ef3d8");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("0b66a83c-da4d-4f10-9619-90f693d141ae");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("68bff1c3-c22a-4d5c-9659-b4686c112fa5");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("cf6d4346-5a1d-4f5f-b08e-0a1f4c956024");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("615b2f16-4c85-4bcd-a8eb-4481655deb57");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("713f0e34-a02d-43b6-bc6c-cb425d10ad48");
	...
	БазаИсточник.Guid = NsgService.StringToGuid("268ee933-1060-489b-9d10-8b110202aab8");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("f0cc6d42-b636-45bf-a194-d7a6b26a16e2");
	...
	НомерОбмена.Guid = NsgService.StringToGuid("f7437b9b-f1f1-4b01-ae63-dec8a31ceaf0");
	...
	ДатаОбмена.Guid = NsgService.StringToGuid("4ff5579a-5635-4100-883e-fc20b15d50b8");
	...
	ВерсияПрограммы.Guid = NsgService.StringToGuid("1e9debaf-e840-426d-afef-16198a942a8b");
	...
	Name = "ПротоколОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("106ae43c-7ece-473b-b6ee-d9d142751bc5");
	DefaultSortingName = "";
