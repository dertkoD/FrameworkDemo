...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "ce3c7cf5-efdf-46e5-8d64-9420e15cf600")]
	...
	Разрешено.GroupName = "";
	Разрешено.Guid = NsgService.StringToGuid("c8e3cee0-a701-4fda-b20e-a7c83bc4dde6");
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ce3c7cf5-efdf-46e5-8d64-9420e15cf600"));
            if (obj == null)
