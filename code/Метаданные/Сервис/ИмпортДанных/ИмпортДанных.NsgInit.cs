...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "af995484-74ce-4220-8126-cd98f6dcc0e0")]
    public partial class ИмпортДанных : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("af995484-74ce-4220-8126-cd98f6dcc0e0"));
            if (obj == null)
