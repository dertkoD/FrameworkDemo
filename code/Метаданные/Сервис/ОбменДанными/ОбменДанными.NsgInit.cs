...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "c19f2d57-51c4-4cd6-9112-a30886f2b8b4")]
    public partial class ОбменДанными : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("c19f2d57-51c4-4cd6-9112-a30886f2b8b4"));
            if (obj == null)
