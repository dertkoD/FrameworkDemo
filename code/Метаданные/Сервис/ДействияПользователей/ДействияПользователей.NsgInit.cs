...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataRegistrationJournal", Guid = "04aabc91-04c5-491f-aab7-aaf4c693020e")]
    public partial class ДействияПользователей : NsgSoft.DataObjects.NsgDataRegistrationJournal
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("04aabc91-04c5-491f-aab7-aaf4c693020e"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("e94f91e3-55af-4a99-b1de-90c70786c8dd");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("486e1abf-ff6d-4f1d-8752-6028cd5c202c");
	...
	ДатаВремя.GroupName = "";
	ДатаВремя.Guid = NsgService.StringToGuid("8f25a54d-9b64-4882-9d4c-91661865d173");
	...
	Пользователь.Guid = NsgService.StringToGuid("70d82887-fff2-4d56-8a2d-3f46053297bf");
	...
	ИдентификаторПользователя.Guid = NsgService.StringToGuid("eac3ad06-9fe6-4e77-9941-62175895aeec");
	...
	СистемныйПользователь.Guid = NsgService.StringToGuid("71e44d3e-9325-4a2f-96ce-200885506c9c");
	...
	Компьютер.GroupName = "";
	Компьютер.Guid = NsgService.StringToGuid("6019d36b-a6f0-49a4-8568-b9755407d658");
	...
	Событие.GroupName = "";
	Событие.Guid = NsgService.StringToGuid("ecd8c610-c9a2-4bbf-b7c8-d12cb4bf5c96");
	...
	Комментарий.Guid = NsgService.StringToGuid("aff2cd55-151d-4c65-ba54-9f661b55e799");
	...
	ИдентификаторОбъекта.Guid = NsgService.StringToGuid("85d4d27c-ac8a-48c4-9740-cb4cc2ac0726");
	...
	ПолноеИмяОбъекта.Guid = NsgService.StringToGuid("7464f85d-6db8-4138-b6fc-f6ca027d2741");
	...
	ГруппаОбъекта.Guid = NsgService.StringToGuid("6d84b834-bdb2-42ab-a612-dd8ce577e202");
	...
	ПредставлениеОбъекта.Guid = NsgService.StringToGuid("5bf7bfd5-6b96-4ef3-addb-bc4cbc42728c");
	...
	Данные.GroupName = "";
	Данные.Guid = NsgService.StringToGuid("2e3bdd9f-73a8-4af9-bad0-01adfbc424ae");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("a74b605f-9fd3-4321-adc4-3a7e3338da64");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("06bfeb09-b327-425a-8958-5a4d61a97929");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("04aabc91-04c5-491f-aab7-aaf4c693020e");
	DefaultSortingName = "";
