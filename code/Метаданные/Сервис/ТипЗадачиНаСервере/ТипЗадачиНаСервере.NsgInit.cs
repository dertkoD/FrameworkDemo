...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "2b635af4-257f-4164-90fb-7782cfa246e8")]
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2b635af4-257f-4164-90fb-7782cfa246e8"));
            if (obj == null)
