...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "1bbfd202-c8d4-4589-be7a-f40b499d543f")]
    public partial class РольПользователяМеню : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1bbfd202-c8d4-4589-be7a-f40b499d543f"));
            if (obj == null)
